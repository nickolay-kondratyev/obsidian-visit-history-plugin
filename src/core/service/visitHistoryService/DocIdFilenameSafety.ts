// Doc ids become VH filenames (V3 `<id>.vh_v3`), and an EXISTING id is
// honored in any format — so it must be validated before use as a path
...
// Consumes stable-ids-for-obsidian's id FORMAT contract (generated ids are always
...
/**
 * Validates doc ids used as VH filenames (V3 focus durations — see
 * VhV3DurationStore).
 */
