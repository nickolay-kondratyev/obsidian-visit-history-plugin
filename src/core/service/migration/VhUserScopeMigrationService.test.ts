...
const LEGACY_V2_FILE = '.plugin_data/visit_history/v2/focus_per_device/mac/doc-a.vh_v2';
const USER_V2_FILE = `.plugin_data/visit_history/user/${USER}/v2/focus_per_device/mac/doc-a.vh_v2`;
const LEGACY_V3_FILE = '.plugin_data/visit_history/v3/focus_duration_per_device/mac/doc-a.vh_v3';
const USER_V3_FILE = `.plugin_data/visit_history/user/${USER}/v3/focus_duration_per_device/mac/doc-a.vh_v3`;
...
describe('VhUserScopeMigrationService', () => {
  describe('migrateIfLegacyPresent', () => {
    ...
    it('should leave no legacy v2 path behind after the move', async () => {
      ...
      expect(await hidden.exists('.plugin_data/visit_history/v2')).toBe(false);
    });
